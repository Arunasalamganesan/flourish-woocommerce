...
class WoocommerceOutboundSettings
{
   ...
   public function update_destination_selection_toggle_callback() {
    ...
    {  
    $all_destination_ids[]=$id;  
    $all_destination_texts[] = $display_text;
    } 
     // Update user meta
    // Store both as serialized arrays in the database 
    update_user_meta($user_id, 'destination_ids', serialize($all_destination_ids));
    update_user_meta($user_id, 'destination_texts', serialize($all_destination_texts));
